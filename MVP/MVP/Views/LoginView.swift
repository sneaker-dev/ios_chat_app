                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(spacing: 0) {
                        ...
                        Text(isRegister ? "Create Account" : "Welcome")
                            .font(.system(size: isLandscape ? 24 : 30, weight: .bold))
                        ...
                        VStack(spacing: isLandscape ? 10 : 16) {
                            VStack(alignment: .leading, spacing: 5) {
                                ...
                                TextField("Enter your email", text: $email)
                                    ...
                                    .frame(height: isLandscape ? 40 : 46)
                                ...
                                HStack(spacing: 0) {
                                    ...
                                    Button { showPassword.toggle() } label: {
                                        Image(systemName: showPassword ? "eye.slash.fill" : "eye.fill")
                                            ...
                                            .frame(width: 40, height: isLandscape ? 40 : 46)
                                    }
                                }
                                .padding(.leading, 14)
                                .background(Color.white)
                            ...
                            Button(action: submit) {
                                ...
                                .frame(maxWidth: .infinity, minHeight: isLandscape ? 44 : 50)
                                .background(
